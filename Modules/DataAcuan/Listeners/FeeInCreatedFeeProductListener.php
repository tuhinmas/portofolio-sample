...
class FeeInCreatedFeeProductListener
{
    /**
     ...
     * @return void
     */
    public function handle(FeeInCreatedFeeProductEvent $event)
    {
        ...
        return $marketing_fee_reguler_reduced;
    }

    /**
     * populate marketing fee according sales order
     * which contain new fee product
     *
     * @param [type] $marketing_fee_reguler
     * @return void
     */
