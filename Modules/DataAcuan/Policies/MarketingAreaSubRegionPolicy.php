...
class MarketingAreaSubRegionPolicy
{
     ...
     *
     * @param  Modules\Authentication\Entities\User  $user
     * @param  \App\Models\SubRegion  $arketing_area_region
     * @return mixed
     */
    public function view(User $user, SubRegion $arketing_area_region)
    {
        return true;
    }
     ...
     * @return mixed
     */
    public function update(User $user, SubRegion $arketing_area_region)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, SubRegion $arketing_area_region)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, SubRegion $arketing_area_region)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, SubRegion $arketing_area_region)
    {
        return $this->responsePolicy($user);
    }
