...
class WarehousePolicy
{
    ...
    public function view(User $user, Warehouse $warehouses)
    {
     ...
     * @return mixed
     */
    public function update(User $user,  Warehouse $warehouses)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, Warehouse $warehouses)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, Warehouse $warehouses)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user,  Warehouse $warehouses)
    {
        return $this->responsePolicy($user);
    }
