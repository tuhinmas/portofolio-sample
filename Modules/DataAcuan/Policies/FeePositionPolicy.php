...
class FeePositionPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, FeePosition $fee_position)
    {
     ...
     *
     * @param User $user
     * @param FeePosition $fee_position
     * @return void
     */
    public function update(User $user, FeePosition $fee_position)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, FeePosition $fee_position)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, FeePosition $fee_position)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, FeePosition $fee_position)
    {
        return $this->responsePolicy($user);
    }
