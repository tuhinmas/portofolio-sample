...
class MarketingPoinPolicy
{
    ...
    public function view(User $user, MarketingPoin $marketingPoin)
    {
     ...
     * @return mixed
     */
    public function update(User $user, MarketingPoin $marketingPoin)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, MarketingPoin $marketingPoin)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, MarketingPoin $marketingPoin)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, MarketingPoin $marketingPoin)
    {
        return $this->responsePolicy($user);
    }
