...
class FeeFollowUpPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, FeeFollowUp $fee_follow_up)
    {
     ...
     *
     * @param User $user
     * @param FeeFollowUp $fee_follow_up
     * @return void
     */
    public function update(User $user, FeeFollowUp $fee_follow_up)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, FeeFollowUp $fee_follow_up)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, FeeFollowUp $fee_follow_up)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, FeeFollowUp $fee_follow_up)
    {
        return $this->responsePolicy($user);
    }
