...
class DealerBenefitPolicy
{
     ...
     *
     * @param  Modules\Authentication\Entities\User  $user
     * @param  \App\Models\DealerBenefit  $dealer_benefit
     * @return mixed
     */
    public function view(User $user, DealerBenefit $dealer_benefit)
    {
     ...
     *
     * @param User $user
     * @param DealerBenefit $dealer_benefit
     * @return void
     */
    public function update(User $user, DealerBenefit $dealer_benefit)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, DealerBenefit $dealer_benefit)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, DealerBenefit $dealer_benefit)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, DealerBenefit $dealer_benefit)
    {
        return $this->responsePolicy($user);
    }
