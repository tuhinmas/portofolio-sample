...
class FeePolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, Fee $fee_reguler)
    {
     ...
     *
     * @param User $user
     * @param Fee $fee_reguler
     * @return void
     */
    public function update(User $user, Fee $fee_reguler)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, Fee $fee_reguler)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, Fee $fee_reguler)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, Fee $fee_reguler)
    {
        return $this->responsePolicy($user);
    }
