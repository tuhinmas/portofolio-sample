...
class SubDealerPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, SubDealer $sub_distributor)
    {
     ...
     * @return mixed
     */
    public function update(User $user, SubDealer $sub_dealer)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, SubDealer $sub_distributor)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, SubDealer $sub_distributor)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, SubDealer $sub_distributor)
    {
        return $this->responsePolicy($user);
    }
