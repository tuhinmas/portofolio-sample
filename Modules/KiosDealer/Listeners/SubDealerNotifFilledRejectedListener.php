...
class SubDealerNotifFilledRejectedListener
{
    /**
     ...
     * @return void
     */
    public function handle(SubDealerFilledRejectedEvent $event)
    {
        /**
        ...
        $details = [
            ...
            'notification_text' => "Pengajuan data " . $event->sub_dealer_temp->name . " ditolak",
        ...
        if ($member) {
            ...
            $notification->notification_text = "Pengajuan data " . $event->sub_dealer_temp->name . " ditolak";
