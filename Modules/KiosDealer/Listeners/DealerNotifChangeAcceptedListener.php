...
class DealerNotifChangeAcceptedListener
{
    /**
     ...
     * @return void
     */
    public function handle(DealerNotifChangeAcceptedEvent $event)
    {
        /**
        ...
        $details = [
            ...
            'notification_text' => "Perubahan data " . $event->dealer_temp->name . " disetujui",
        ...
        if ($member) {
            ...
            $notification->notification_text = "Perubahan data " . $event->dealer_temp->name . " disetujui";
            ...
            $notification->data_id = $event->dealer_temp->dealer_id;
        ...
        UserDevice::query()
            ...
            ->each(function ($player) use ($event) {
                $oneData = [
                    ...
                    "subtitle" => "Perubahan data " . $event->dealer_temp->name . " disetujui",
                    "data_id" => $event->dealer_temp->dealer_id,
                    "message" => "Perubahan data " . $event->dealer_temp->name . " disetujui",
                    "mobile_link" => "/DealerInfo",
                    "notification" => "Perubahan data " . $event->dealer_temp->name . " disetujui",
                    "contents" => [
                        "en" => "Perubahan data " . $event->dealer_temp->name . " disetujui",
                        "in" => "Perubahan data " . $event->dealer_temp->name . " disetujui",
                    ],
                    "menu" => "Dealer",
                    "is_supervisor" => false,
                ];
