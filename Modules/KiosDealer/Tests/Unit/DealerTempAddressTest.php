 ...
 * can create batch
 */
test("dealer temp address: v2 batch, can create address with valid data", function () {
 ...
 */
test("dealer temp address: v2 batch, can not create address if exist", function () {
    $dealer_temp = DealerTemp::factory()->create();
...
test("dealer temp address: v2 batch, can not create duplicate address", function () {
    $dealer_temp = DealerTemp::factory()->create();
 ...
 * can create single
 */
test("dealer temp address: v2 single, can create address with valid data", function () {
    $dealer_temp = DealerTemp::factory()->create();
 ...
 */
test("dealer temp address: v2 single, can not create address if exist", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
    ]);
 ...
 * can update batch
 */
test("dealer temp address: v2 batch, can update address with valid data", function () {
    $dealer_temp = DealerTemp::factory()->create();
 ...
 */
test("dealer temp address: v2 batch, can not update address if exist", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp_1 = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
        "parent_id" => $dealer_temp->id,
...
test("dealer temp address: v2 batch, can not update duplicate address", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp_1 = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
        "parent_id" => $dealer_temp->id,
 ...
 * can update single
 */
test("dealer temp address: v2 single, can update address with valid data", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp_1 = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
        "parent_id" => $dealer_temp->id,
 ...
 */
test("dealer temp address: v2 single, can not update address if there exist", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp_1 = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
        "parent_id" => $dealer_temp->id,
 ...
 * can create batch
 */
test("dealer temp address: v1 batch, can create address with valid data", function () {
    $dealer_temp = DealerTemp::factory()->create();
 ...
 * can not create batch
 */
test("dealer temp address: v1 batch, can not create address if exist", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
    ]);
...
test("dealer temp address: v1 batch, can not create duplicate address", function () {
    $dealer_temp = DealerTemp::factory()->create();
 ...
 * can create single
 */
test("dealer temp address: v1 single, can create address with valid data", function () {
    $dealer_temp = DealerTemp::factory()->create();
 ...
 * can not create single
 */
test("dealer temp address: v1 single, can not create address if exist", function () {
    $dealer_temp = DealerTemp::factory()->create();
    $address_temp = AddressTemp::factory()->create([
        "parent_id" => $dealer_temp->id,
    ]);
