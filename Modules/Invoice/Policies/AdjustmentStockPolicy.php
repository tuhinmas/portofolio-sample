...
class AdjustmentStockPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, AdjustmentStock $adjustmentstock)
    {
     ...
     * @return mixed
     */
    public function update(User $user, AdjustmentStock $adjustmentstock)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, AdjustmentStock $adjustmentstock)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, AdjustmentStock $adjustmentstock)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, AdjustmentStock $adjustmentstock)
    {
        return $this->responsePolicy($user);
    }
