...
use Modules\Invoice\Console\PaymentStatusFixingCommand;
...
class InvoiceServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // $this->app['events']->listen(PaymentOnSettleEvent::class, UpdateMarketingFeeBaseFeeSharingListener::class);
        // $this->app['events']->listen(PaymentOnSettleEvent::class, UpdateLogMarketingFee::class);

        $this->commands([
            PaymentStatusFixingCommand::class
        ]);
    }
