...
class ListDispatchOrderPolicy
{
    ...
    public function view(User $user, ListDispatchOrder $listDispatchOrder)
    {
     ...
     * @return mixed
     */
    public function update(User $user, ListDispatchOrder $listDispatchOrder)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, ListDispatchOrder $listDispatchOrder)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function restore(User $user, ListDispatchOrder $listDispatchOrder)
    {
        return $this->responsePolicy($user);
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, ListDispatchOrder $listDispatchOrder)
    {
        return $this->responsePolicy($user);
    }
