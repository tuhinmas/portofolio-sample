...
class MarketingFeeCounterV3Command extends Command
{
     ...
     * @var string
     */
    protected $name = 'fee:marketing_fee_counter_v3';
     ...
     * @var string
     */
    protected $description = 'reclaculate and generate all marketing fee. the different is on how to use fee product reference depend on product_as';
    ...
    public function handle(
        ...
        GetMarketingQuantityAchievementAction $marketing_achievement,
        ...
        try {
                        ...
                        ->each(function ($personel) use (
                            ...
                            $sales_orders = $this->sales_order->query()
                                ...
                                ->each(function ($order) use (
                                    ...
                                    // /* fee target */
                                    $generate_fee_target_sharing_action($order, $active_contract);
            ...
            /* telegram notifcation */
            telegram_notiication("Oops! Recalculate Fee Marketing fail");
